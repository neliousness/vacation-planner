...
object Constants {
    ...
    val tokyoItineraryResponse = LocationItinerary(
            ...
            ItineraryData(
                ...
                activities = listOf(
                    Activity(
                        ...
                        location = Location(name = "Shibuya Crossing", latitude = 35.6591, longitude = 139.7002),
                        meal = "Ramen at Ichiran Shibuya"
                    ),
                    Activity(
                        name = "Shinjuku Gyoen National Garden",
                        description = "Explore this tranquil oasis.",
                        location = Location(name = "Shinjuku Gyoen", latitude = 35.6853, longitude = 139.7076),
            ...
            ItineraryData(
                ...
                activities = listOf(
                    Activity(
                        ...
                        location = Location(name = "Senso-ji Temple", latitude = 35.7148, longitude = 139.7968),
                        meal = "Street food in Asakusa"
                    ),
                    Activity(
                        name = "Imperial Palace East Garden",
                        description = "Explore the Emperor's gardens.",
                        location = Location(name = "Imperial Palace", latitude = 35.6856, longitude = 139.7532),
    ...
    val parisItineraryResponse = LocationItinerary(
            ...
            ItineraryData(
                ...
                activities = listOf(
                    ...
                    Activity(
                        ...
                        location = Location(name = "Louvre Museum", latitude = 48.8606, longitude = 2.3376),
            ...
            ItineraryData(
                ...
                activities = listOf(
                    Activity(
                        ...
                        location = Location(name = "Montmartre", latitude = 48.8864, longitude = 2.3431),
                        meal = "Crêpes at a street vendor"
                    ),
                    Activity(
                        name = "Latin Quarter",
                        description = "Explore the historic Latin Quarter.",
                        location = Location(name = "Latin Quarter", latitude = 48.8467, longitude = 2.3428),
    ...
    val newYorkItineraryResponse = LocationItinerary(
            ...
            ItineraryData(
                ...
                activities = listOf(
                    Activity(
                        ...
                        location = Location(name = "Times Square", latitude = 40.7589, longitude = -73.9851),
                        meal = "New York-style pizza"
                    ),
                    Activity(
                        name = "Empire State Building",
                        description = "Ascend to the top for city views.",
                        location = Location(name = "Empire State Building", latitude = 40.7484, longitude = -73.9857),
            ...
            ItineraryData(
                ...
                activities = listOf(
                    Activity(
                        ...
                        location = Location(name = "Statue of Liberty", latitude = 40.6892, longitude = -74.0445),
                        meal = "Lunch at a café in Battery Park"
                    ),
                    Activity(
                        name = "9/11 Memorial & Museum",
                        description = "Reflect on the events of 9/11.",
                        location = Location(name = "9/11 Memorial", latitude = 40.7115, longitude = -74.0124),
    ...
    val londonItineraryResponse = LocationItinerary(
            ...
            ItineraryData(
                ...
                activities = listOf(
                    Activity(
                        ...
                        location = Location(name = "Buckingham Palace", latitude = 51.5014, longitude = -0.1419),
                        meal = "Afternoon tea at The Ritz"
                    ),
                    Activity(
                        name = "Tower of London",
                        description = "Explore the historic fortress.",
                        location = Location(name = "Tower of London", latitude = 51.5081, longitude = -0.0759),
            ...
            ItineraryData(
                ...
                activities = listOf(
                    Activity(
                        ...
                        location = Location(name = "British Museum", latitude = 51.5194, longitude = -0.1269),
                        meal = "Lunch at a pub in Bloomsbury"
                    ),
                    Activity(
                        name = "National Gallery",
                        description = "Admire European paintings.",
                        location = Location(name = "National Gallery", latitude = 51.5089, longitude = -0.1283),
    ...
    val locationItinerarys = listOf(dummyItineraryResponse,tokyoItineraryResponse,
