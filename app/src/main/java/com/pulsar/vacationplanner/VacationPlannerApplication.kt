...
class VacationPlannerApplication : Application() {
    ...
    override fun onCreate() {
        ...
        startKoin{
            ...
            modules(presentationModule, networkModule, helperModule, useCasesModule)
        }
    }
}